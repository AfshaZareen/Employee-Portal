      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredStudents.length > 0 ? (
          filteredStudents.map((student) => (
            <div key={student.id} className="bg-purple-200 shadow-lg rounded-lg p-4 text-center transition transform hover:scale-105 hover:shadow-xl">
              ...
              <button
                className="mt-3 px-4 py-2 bg-purple-800 text-white rounded-lg hover:bg-[#4A90E2] transition transform hover:scale-105 hover:shadow-md"
